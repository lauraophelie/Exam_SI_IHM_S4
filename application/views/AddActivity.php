...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title> Ajouter Activité | Admin </title>
...
<body>
  ...
  <div class="container-fluid d-flex align-items-center">
    <h1 class="d-flex align-items-center fs-4 text-white mb-0">
      Trim Life Admin: Ajouter un Activite
    </h1>
  </div>
</nav>
    <div class="container">
      <div class="text-center" style="color:#0d6efd;"><p class="h2" >Ajouter un Activité</p></div>
      <div class="my-4"></div>
      <center>
        <form class="needs-validation" action="<?php echo base_url('Controller_48h/addNewActivity'); ?>" method="post">
          <div class="row g-3">
            <div class="col-12">
