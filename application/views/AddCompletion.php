...
<body>
  ...
  <div class="container-fluid d-flex align-items-center">
    <h1 class="d-flex align-items-center fs-4 text-white mb-0">
      Trim Life : Ajouter une completion
    </h1>
  </div>
</nav>
<div class="container">
      ...
      <form class="needs-validation" action="<?php echo base_url('Controller_48h/insertDetailUser');?>" method="post">
        ...
        <div class="row g-3">
          <div class="col-sm-6">
            ...
            <input type="number" min="100" step="1" max="350" class="form-control" id="taille" name="taille" placeholder="inserez votre Taille" required>
            <div class="invalid-feedback">
              veuiller entrer un poid valide.
            </div>
          </div>
          ...
          <div class="col-12">
            ...
            <select class="form-select" id="objectif" name="objectif" required>
              ...
              <option value="<?php echo $valueObj->id;?>"><?php echo $valueObj->designation;?></option>
              <?php  } ?>
            </select>
            <div class="invalid-feedback">
