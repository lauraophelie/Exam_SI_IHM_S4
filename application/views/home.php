  ...
  <div class="sidebar">
    <div class="logo-details">
      <i class='bx bxl-c-plus-plus icon'></i>
        <div class="logo_name">Examen S4</div>
...
<footer class="footer mt-auto py-3 bg-dark">
  <div class="container">
    <span class="text-muted">
      ...
      <li class="nav-item"><div class="nav-link px-2 text-muted">Addresse: IT University, Antananarivo, Andoharanofotsy</div></li>
      <li class="nav-item"><div class="nav-link px-2 text-muted">Contact: +261 12 345 67</div></li>
      <li class="nav-item"><div class="nav-link px-2 text-muted">E-mail: Eemple@Gmail.Com</div></li>
    </ul>
    <p class="text-center text-muted">Examen S4 © 2023 IT University</p>
  </span>
  </div>
</footer>
